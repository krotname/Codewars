...
public class EncryptThis {
    ...
    public void exampleTests() {
        assertEquals("65 119esi 111dl 111lw 108dvei 105n 97n 111ka",
                EncryptThis.encryptThis("A wise old owl lived in an oak"));
        assertEquals("119esi 111dl 111lw 108dvei 105n 97n 111ka",
                EncryptThis.encryptThis("wise old owl lived in an oak"));
        assertEquals("",
                EncryptThis.encryptThis(""));
        assertEquals("84eh 109ero 104e 115wa 116eh 108sse 104e 115eokp",
                EncryptThis.encryptThis("The more he saw the less he spoke"));
